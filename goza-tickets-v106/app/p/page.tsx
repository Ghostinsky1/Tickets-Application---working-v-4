    ...
    <div style={{ minHeight: '100vh', background: C.bg, color: '#fff', fontFamily: F, padding: '26px 18px 60px' }}>
      <div style={{ maxWidth: 560, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
          <span style={{ fontFamily: FL, fontWeight: 700, fontSize: 10.5, letterSpacing: 3, color: C.blue, textTransform: 'uppercase' }}>Goza · Promoter</span>
          <a href="/account" style={{ color: C.muted, fontSize: 13, textDecoration: 'none', borderBottom: `1px solid ${C.line}` }}>My tickets &rarr;</a>
        </div>
