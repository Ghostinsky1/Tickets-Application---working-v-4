        ...
        <div style={{ position: 'relative', minHeight: '100vh' }}>
          ...
          {torchable && (
            <button onClick={toggleTorch}
              style={{ display: 'block', margin: '12px auto 0', background: torchOn ? '#f0b64b' : 'rgba(255,255,255,0.1)', color: torchOn ? '#000' : '#fff', border: 'none', borderRadius: 12, padding: '12px 22px', fontSize: 15, fontWeight: 800, cursor: 'pointer' }}>
