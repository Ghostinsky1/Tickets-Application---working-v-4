...
interface Info {
  event: { id: string; name: string; date: string; location: string; imageUrl: string | null; description: string | null; musicUrl: string | null; logoUrl: string | null; buttonColor?: string; accentColor?: string };
