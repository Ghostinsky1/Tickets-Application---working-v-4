...
interface Info {
  event: { id: string; name: string; date: string; endDate?: string | null; ageRestriction?: string | null; eventMode?: string; maxPerOrder?: number; hideVenue?: boolean; areaLabel?: string | null; location: string; imageUrl: string | null; description: string | null; musicUrl: string | null; logoUrl: string | null; buttonColor?: string; accentColor?: string };
